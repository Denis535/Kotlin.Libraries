...
val ProjectDescription = "The library that allows you to easily implement a hierarchical object."
val ProjectUrl = "https://github.com/Denis535/Kotlin.Libraries/tree/main/tree-machine-pro"
        ...
        this.create<MavenPublication>("mavenJava") {
            ...
            this.pom {
                ...
                this.scm {
                    ...
                    this.url.set("https://github.com/Denis535/Kotlin.Libraries/tree/main/tree-machine-pro")
                }
            }
        }
    }
